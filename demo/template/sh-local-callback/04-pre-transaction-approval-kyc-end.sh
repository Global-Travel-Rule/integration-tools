...
encryptedPayload=$(curve25519_from_file $myPriv $LOCAL_CALLBACK_SERVER_PUBLIC_KEY $basedir/../ivms/pre_ivms_kyc.json)
...
curl --no-progress-meter --location --request POST "http://localhost:8080/callback" \
    ...
    \"callbackData\": {
        ...
        \"basicMessage\": {
            ...
            \"beneficiaryVaspCode\": \"$LOCAL_CALLBACK_SERVER_VASP_CODE\",
            \"initiatorVaspCode\": \"$TESTER_VASP_CODE\",
            \"receiverVaspCode\": \"$LOCAL_CALLBACK_SERVER_VASP_CODE\",
            \"invokeVaspCode\": \"$LOCAL_CALLBACK_SERVER_VASP_CODE\",
            \"verificationDirection\": 2
        }
    }
